...
`,We=({isSlideShow:i,setIsSlideShow:d,currentSlideNum:c})=>{const o=r.useRef([]),s=r.useRef(null),[a,p]=r.useState(0),x=()=>{if(o.current[0]&&s.current){const l=o.current[0].getBoundingClientRect().width,v=s.current.getBoundingClientRect().width;if(a===0){const k=v*-1+l;p(k)}else{const k=a+l;p(k)}}},h=()=>{if(o.current[0]&&s.current){const l=o.current[0].getBoundingClientRect().width;if(s.current.getBoundingClientRect().width<=Math.abs(a)+l)p(0);else{const k=a-l;p(k)}}};r.useEffect(()=>{if(i&&o.current[0]){const l=o.current[0].getBoundingClientRect().width,v=c===1?0:l*(c-1)*-1;p(v)}},[i]);let u=0,b=0;const m=l=>{u=l.pageX},A=(l,v)=>{l!=v&&(l<v?x():h())},_=l=>{b=l.pageX,A(u,b)};let g=!1;const f=l=>{if(l.touches.length>1){g=!0,l.isPropagationStopped();return}g=!1,u=l.touches[0].pageX},y=l=>{g||(b=l.changedTouches[0].pageX,A(u,b))},w=()=>d(!1),N=Ie.map((l,v)=>e(Ee,{children:e("img",{ref:W=>o.current[v]=W,src:(()=>new URL(Object.assign({"../assets/images/img_1.jpeg":be,"../assets/images/img_10.jpeg":_e,"../assets/images/img_11.jpeg":we,"../assets/images/img_12.jpeg":ve,"../assets/images/img_13.jpeg":ye,"../assets/images/img_14.jpeg":ke,"../assets/images/img_2.jpeg":je,"../assets/images/img_3.jpeg":Ce,"../assets/images/img_4.jpeg":Be,"../assets/images/img_5.jpeg":Se,"../assets/images/img_6.jpeg":$e,"../assets/images/img_7.jpeg":Re,"../assets/images/img_8.jpeg":Te,"../assets/images/img_9.jpeg":ze})[`../assets/images/${l}.jpeg`],self.location).href)(),"data-value":l,alt:"갤러리 이미지"})},v));return i?n(Me,{children:[n(Le,{children:[e(Ge,{children:"이미지 팝업창"}),e(Fe,{ref:s,style:{left:a},onMouseDown:m,onMouseUp:_,onTouchStart:f,onTouchEnd:y,children:N}),n(Pe,{children:[e(Oe,{onClick:x,children:"이전"}),e(Ne,{onClick:h,children:"다음"})]}),e(Ue,{onClick:w,children:"팝업창 닫기"})]}),e(De,{onClick:w})]}):e(L,{})},He=t.section`
    padding: 36px 0;
...
`,z={name:"이름을 입력해주세요.",content:"내용을 입력해주세요.",password:"비밀번호를 입력해주세요. (메세지 삭제할 때 필요)"},ut=()=>{const{handleSubmit:i,handleChange:d,isSubmitEnter:c,inputDatas:o,guestBooks:s,nameRef:a,onClickDeleteBtn:p}=it(),x=r.useRef(null);return n(ot,{"data-scroll":!0,ref:x,children:[e(pt,{children:"게스트 북"}),e(st,{children:n("form",{onSubmit:i,children:[n("div",{children:[e(rt,{name:"name",type:"text",placeholder:"이름",onChange:d,value:o.name,ref:a}),e(T,{children:c&&o.name===""?z.name:""})]}),n("div",{children:[e(at,{name:"content",rows:2,placeholder:"축하 내용을 입력해주세요!",onChange:d,value:o.content}),e(T,{children:c&&o.content===""?z.content:""})]}),n(ct,{children:[n("div",{children:[e(dt,{name:"password",type:"password",placeholder:"비밀번호 입력",onChange:d,value:o.password}),e(T,{children:c&&o.password===""?z.password:""})]}),e(lt,{type:"submit",children:"입력"})]})]})}),e("section",{children:s.map((h,u)=>n(gt,{children:[n(ht,{children:[n("li",{children:["이름 : ",h.name]}),e("li",{children:h.content})]}),h.id===1?e(L,{}):e(mt,{type:"button",onClick:()=>p(h.id),children:"삭제"})]},`guest-${u}`))})]})},xt=t.section`
    padding: 80px 0;
    display: flex;
    align-items: center;
    flex-direction: column;
...
`,vt=t.h2`
    ...
    left: -9999px;
    top: -9999px;
`,yt=()=>n(xt,{"data-scroll":!0,children:[e(vt,{children:"소개글"}),n(At,{children:[e($,{children:"우"}),"리 결혼합니다.",e("br",{}),e($,{children:"준"}),"비된 자세로 배우며 살아가겠습니다.",e("br",{}),e("br",{}),e($,{children:"소"}),"중한 사람과",e("br",{}),e($,{children:"희"}),"로애락을 함께 하겠습니다."]}),[{name:"김우준",mother:"백숙현",father:"김동필",rank:"차남"},{name:"김소희",mother:"김나현",father:"김상현",rank:"장녀"}].map((d,c)=>n(wt,{children:[n(ft,{children:[e("li",{children:d.father}),e("li",{children:d.mother})]}),n(bt,{children:["의 ",d.rank," ",e(_t,{children:d.name})]})]},c))]}),kt="/wedding-card/assets/bg-c7833e65.jpg",jt=t.section`
    overflow: hidden;
    position: relative;
...
`,Rt=t.h2`
    ...
    left: -9999px;
    top: -9999px;
`,Tt=()=>{const i=r.useRef([]);r.useEffect(()=>{i.current&&i.current.map(o=>{new H(o,{speed:-2,center:!1,round:!0,vertical:!0,horizontal:!1})})},[]);const d={bridegroom:"김우준",bride:"김소희",place:"분당앤스퀘어 4층 컨벤션홀",date:"2023-06-10 12:00"},c=()=>{const o=new Date(d.date),s=new Date,a=o.getTime()-s.getTime(),p=Math.round(a/(1e3*60*60*24)),x=o.getHours()<12?"오전":"오후",h=o.getMinutes()?`${o.getMinutes()}분`:"",u=`${x} ${o.getHours()}시 ${h}`;return{weddingDay:`${o.getFullYear()}년 ${o.getMonth()+1}월 ${o.getDate()}일 ${u}`,dday:p}};return n(jt,{children:[e(Rt,{children:"메인페이지"}),n(Ct,{ref:o=>i.current[0]=o,"data-rellax-speed":"-3",children:["우준",e(Bt,{children:"and"}),"소희"]}),n(St,{ref:o=>i.current[1]=o,"data-rellax-speed":"-3",children:[c().weddingDay,e("br",{}),d.place]}),n($t,{ref:o=>i.current[2]=o,"data-rellax-speed":"1",children:["D-",c().dday]})]})},zt=t.div`
    padding: 16px;
`,It=t.a`
    display: block;
    z-index: 2;
...
`,Et=t.div`
    ...
    border-radius: 8px;
`,Mt={center:new naver.maps.LatLng(37.34,127.1067),scaleControl:!1,mapDataControl:!1,zoom:16,draggable:!1,scrollWheel:!1},Lt=()=>{const i=r.useRef(null);return r.useEffect(()=>{if(i.current){const c=new naver.maps.Map(i.current,Mt);new naver.maps.Marker({position:c.getCenter(),map:c})}},[]),e(zt,{children:e(It,{href:"https://naver.me/xdIkk34F",target:"_blank",children:e(Et,{ref:i,style:{width:"100%",height:"400px"},children:"지도"})})})},Dt=t.section`
    padding: 36px 0;
...
`,R=t.button`
    ...
    color: #2196F3;
    cursor: pointer;
`,Zt=()=>{const[i,d]=r.useState(!1),[c,o]=r.useState(""),s=a=>{const p=a.target.getAttribute("data-value");p&&(o(p),d(!0))};return n(Jt,{children:[e(Qt,{children:"축하의 마음 전하기"}),n(Yt,{children:[n(O,{children:[n("li",{children:[e("span",{children:"신랑 아버지"}),e(R,{type:"button","data-value":"김동필,신랑,SC제일은행 43320089765",onClick:s,children:"계좌"})]}),n("li",{children:[e("span",{children:"신랑 어머니"}),e(R,{type:"button","data-value":"백숙현,신랑,농협은행 10502330024",onClick:s,children:"계좌"})]})]}),n(O,{children:[n("li",{children:[e("span",{children:"신부 아버지"}),e(R,{type:"button","data-value":"김상현,신부,국민은행 284210052682",onClick:s,children:"계좌"})]}),n("li",{children:[e("span",{children:"신부 어머니"}),e(R,{type:"button","data-value":"김나현,신부,국민은행 284240015077",onClick:s,children:"계좌"})]})]})]}),e(qt,{isShow:i,setIsShow:d,data:c})]})},en=()=>(r.useEffect(()=>{V({threshold:.2,once:!0})},[]),n("div",{children:[e(Tt,{}),e(yt,{}),e(oe,{}),e(Ye,{}),e(Ut,{}),e(Zt,{}),e(ut,{})]}));const tn=K.createRoot(document.getElementById("root"));tn.render(e(X,{children:e(q,{basename:"/wedding-card",children:e(J,{children:e(Q,{path:"/",element:e(en,{})})})})}));
